...
import firefoxReadingmode from "./assets/screenshots/firefox-readingmode.png";
import pocket from "./assets/screenshots/pocket.png";
import landmarkNavigation from "./assets/screenshots/landmark-navigation.png";
import telegramLeiturarapida from "./assets/screenshots/telegram-leiturarapida.jpg";
import googleReceita from "./assets/screenshots/google-receita.png";
import googleNoticias from "./assets/screenshots/google-noticias.png";
import googleReviews from "./assets/screenshots/google-reviews.png";
import googleassistantPreview from "./assets/screenshots/googleassistant-preview.jpg";
import applewatchArticle from "./assets/screenshots/applewatch-article.png";
import applewatchFigure from "./assets/screenshots/applewatch-figure.png";
import applewatchInputs from "./assets/screenshots/applewatch-inputs.png";
import applewatchLabel from "./assets/screenshots/applewatch-label.png";

import { Sandpack, getSandpackCssText } from "@codesandbox/sandpack-react";
import niceInputHtml from "./assets/nice-input.html?raw";
import notNiceInputHtml from "./assets/not-nice-input.html?raw";

<style id="sandpack" set:html={getSandpackCssText()} />
...
<button class="button" style="all: revert" onclick='javascript:alert("Oi, eu sou o Goku!")'>
	Clique aqui
</button>
...
<img src={firefoxReadingmode} alt="Modo de leitura do Firefox" />

<div class="img-caption">Modo de leitura do Firefox</div>

<img src={pocket} alt="Artigo no Pocket" />

<div class="img-caption">Artigo no Pocket</div>

<img src={landmarkNavigation} alt="Outline de página usando landmarks" />

<div class="img-caption">
	Outline de página baseado em <i lang="en">landmarks</i>
</div>

<img src={telegramLeiturarapida} alt="Leitura rápida do Telegram" />
...
<img src={googleReceita} alt="Busca por receita no Google" />

<div class="img-caption">Busca por receita no Google</div>

<img src={googleNoticias} alt="Busca por notícias no Google" />

<div class="img-caption">Busca por notícias no Google</div>

<img src={googleReviews} alt="Busca por filme no Google" />

<div class="img-caption">Busca por filme no Google</div>

<img src={googleassistantPreview} alt="Resposta do Google Assistant" />
...
> <q>
> 	I didn’t choose to use &lt;article> and `itemprop` and input types because I wanted to support
> 	the Apple Watch; I did it before the Apple Watch existed, in order that my code is
> 	future-proof. By choosing the right semantics now, a machine that I don’t know about yet can
> 	understand my content and display it in the best way for its users
> </q>
>
...
<img src={applewatchArticle} alt="Modo de leitura" />

<div class="img-caption">Modo de leitura</div>

<img src={applewatchFigure} alt="Exibição de figure" />

<div class="img-caption">Exibição de figure</div>

<img src={applewatchInputs} alt="Diferentes tipos de input" />

<div class="img-caption">Diferentes tipos de input</div>

<img src={applewatchFigure} alt="Exibição de input com label" />
...
> <q>
> 	when a HTML component sets the hidden={true} property, React will automatically change the
> 	priority of this subtree so that it won’t be part of the initial render. The idea is to e.g
> 	have a tab component that can render out every window in advance so switching tabs is super
> 	fast but it only needs to display the first tab’s content in the initial render so the hidden
> 	tabs can be deprioritized
> </q>
>
