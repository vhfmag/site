...
[uhu](codesandbox://src/content/posts/o-valor-pratico-do-html/assets/not-nice-input?module=/index.html)

Bastaria ter substituído o insignificante (porque sem significado) `<span>` por um `<label>` e quem sabe meu dedo gordo não teria me impedido de clicar no <i lang='en'>checkbox</i> no meu celular e eu teria te dado direito de venda sobre meus dados sem nem ler os termos:

[uhu](codesandbox://src/content/posts/o-valor-pratico-do-html/assets/nice-input?module=/index.html)
...
É isso o que HTML é, afinal de contas: um vocabulário comum que contem os principais elementos interativos, tipográficos e de separação de conteúdo (discorda? falta algum? manda sua ideia pro [discourse do WICG](https://discourse.wicg.io/) e [contribua você também para a Web](https://medium.com/dev-channel/engaging-in-web-standards-the-compatible-with-most-web-developers-approach-eae5f624a5b7)). Ao usar esse vocabulário tão bem quanto possível, nossos dispositivos e ferramentas ficam bem informados e podem oferecer a melhor experiência para o seu usuário, de acordo com seu [fator de forma](<https://en.wikipedia.org/wiki/Form_factor_(design)>) e outras limitações.

### Tem valor para quem não usa a Web como você

Nem todo mundo usa a Web como você. Talvez não você saiba, ou talvez você ache que isso não é relevante o seu nicho de mercado. Vamos tratar das duas hipóteses aqui.

Eu acesso a Web com um navegador (Firefox desktop e mobile), usando teclado e mouse ou tela sensível ao toque, a partir de um computador ou celular e com uma conexão de boa a razoável. Mas eu erraria ao supor que todos acessam nossos sites nessas condições. Afinal, nem todos acessam:
...
-   Você começar da base que o HTML te dá, ou começar do zero. Em geral, a primeira opção ganha
-   HTML semântico e dados estruturados te permite expressar forma e conteúdo de uma forma inteligível por bots e <i lang='en'>crawlers</i>, melhorando o seu SEO e permitindo novas formas de interação com o seu site
...
Como uma nota adicional, eu descobri o elemento `<dialog>` por causa dos meus estudos pra preparar esse artigo e a apresentação e acabei usando ele no trabalho! Não apenas por ser semântico, mas pela sua garantia de ficar sobre o restante da página. 😉
